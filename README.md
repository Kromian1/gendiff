...
Gendiff — консольная утилита для поиска различий между двумя файлами.

Возможности:

- сравнение JSON и YAML файлов;
- поддержка вложенных структур;
- вывод в форматах `stylish`, `plain` и `json`;
- использование как CLI-инструмента и как PHP-библиотеки.
...
|---------------|------------|
| `bin/gendiff` | CLI-точка входа |
| `src/Differ.php` | Построение дерева различий |
| `src/Parser.php` | Парсинг входных файлов |
| `src/Formatter.php` | Выбор форматтера |
| `src/Contracts/` | Интерфейсы парсеров, форматтеров и вычислителей |
| `src/Formatters/` | Форматтеры Stylish, Plain и Json |
| `src/functions.php` | Публичный API библиотеки |
